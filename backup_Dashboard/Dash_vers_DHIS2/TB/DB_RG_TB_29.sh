...
CSV_FILE="/home/herinomena/Documents/Export_dashbord_DHIS/Script_Migration_Dash_vers_DHIS2/TB/DB_RG_TB_29"

# Define SQL query
SQL_QUERY="SELECT 
    'zZnyD4P3nkU' AS 'dataelement',
