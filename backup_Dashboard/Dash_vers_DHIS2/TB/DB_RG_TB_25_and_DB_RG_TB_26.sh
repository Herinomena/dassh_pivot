...
CSV_FILE="/home/herinomena/Documents/Export_dashbord_DHIS/Script_Migration_Dash_vers_DHIS2/TB/DB_RG_TB_25_and_DB_RG_TB_26"

# Define SQL query
SQL_QUERY="SELECT 
   if(v.phase=0,'z6kwz9QMShh',if ( v.phase=1,'bJ8fZ8CxIYN',null)) AS 'dataelement',
