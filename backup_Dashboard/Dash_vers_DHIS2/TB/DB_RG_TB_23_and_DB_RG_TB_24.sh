...
CSV_FILE="/home/herinomena/Documents/Export_dashbord_DHIS/Script_Migration_Dash_vers_DHIS2/TB/DB_RG_TB_23_and_DB_RG_TB_24"

# Define SQL query
SQL_QUERY="SELECT 
   if(v.phase=0,'qyCdZaxUWuL',if ( v.phase=1,'IIOqON5dpgz',null)) AS 'dataelement',
