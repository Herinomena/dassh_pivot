...
CSV_FILE="/home/herinomena/Documents/Export_dashbord_DHIS/Script_Migration_Dash_vers_DHIS2/KOBO/DB_KB_MNT_DBT_SENSIB_1_to_4"
...
SELECT  
 Case dbc.name
 when 'DB_KB_MNT_DBT_SENSIB_1' then 'wdp8ITKTydD'
 when 'DB_KB_MNT_DBT_SENSIB_2' then 'MLlZqRTXmz3'
 when 'DB_KB_MNT_DBT_SENSIB_3' then 'BhyzUySsIip'
 when 'DB_KB_MNT_DBT_SENSIB_4' then 'lUxgmMgXrL6'
 END AS 'dataelement',
...
WHERE
    dbc.name IN ('DB_KB_MNT_DBT_SENSIB_1','DB_KB_MNT_DBT_SENSIB_2','DB_KB_MNT_DBT_SENSIB_3','DB_KB_MNT_DBT_SENSIB_4')
