...
CSV_FILE="/home/herinomena/Documents/Export_dashbord_DHIS/Script_Migration_Dash_vers_DHIS2/KOBO/DB_KB_TB_1_to_21"
...
SELECT  
 Case dbc.name
 when 'DB_KB_TB_1' then 'bqVa3nHxNBl'
 when 'DB_KB_TB_2' then 'xxMcfcfnko7'
 when 'DB_KB_TB_3' then 'JVaTs0CCW1i'
 when 'DB_KB_TB_4' then 'SGQHRVy8vRZ'
 when 'DB_KB_TB_5' then 'qMzKslIfy9n'
 when 'DB_KB_TB_6' then 'Z687mTVMvEX'
 when 'DB_KB_TB_7' then 'b76u74FrpNK'
 when 'DB_KB_TB_8' then 'WRbiaFW7pWY'
 when 'DB_KB_TB_9' then 'ClntVed8FDI'
 when 'DB_KB_TB_10' then 'ijE8HNbpsu9'
 when 'DB_KB_TB_11' then 'jm2e1vaqZwe'
 when 'DB_KB_TB_12' then 'JwRDpudUXMg'
 when 'DB_KB_TB_13' then 'bIF8QGMxV7j'
 when 'DB_KB_TB_14' then 'HJE4kpAYaV7'
 when 'DB_KB_TB_15' then 't4B3BjgCGLY'
 when 'DB_KB_TB_16' then 'i7k3SYsIHS4'
 when 'DB_KB_TB_17' then 'JnarwpnDH9X'
 when 'DB_KB_TB_18' then 'bfRnjPtCHgx'
 when 'DB_KB_TB_19' then 'mJQSoIPGH3C'
 when 'DB_KB_TB_20' then 'pc3BMkCELIR'
  when 'DB_KB_TB_21' then 'J6EBFQMwC1H'
 END AS 'dataelement',
...
WHERE
    dbc.name IN ('DB_KB_TB_1','DB_KB_TB_2','DB_KB_TB_3','DB_KB_TB_4','DB_KB_TB_5','DB_KB_TB_6','DB_KB_TB_7','DB_KB_TB_8','DB_KB_TB_9','DB_KB_TB_10','DB_KB_TB_11','DB_KB_TB_12','DB_KB_TB_13','DB_KB_TB_14','DB_KB_TB_15','DB_KB_TB_16','DB_KB_TB_17','DB_KB_TB_18','DB_KB_TB_19','DB_KB_TB_20','DB_KB_TB_21')
