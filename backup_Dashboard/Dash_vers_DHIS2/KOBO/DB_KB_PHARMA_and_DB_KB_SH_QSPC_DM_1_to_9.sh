...
CSV_FILE="/home/herinomena/Documents/Export_dashbord_DHIS/Script_Migration_Dash_vers_DHIS2/KOBO/DB_KB_PHARMA_and_DB_KB_SH_QSPC_DM_1_to_9"
...
SELECT  
 Case dbc.name
 when 'DB_KB_AG_PHARMA_1' then 'qkNjX2HKSf9'
 when 'DB_KB_STOCK_PHARMA_1' then 'xUotKkb6xlX'
 when 'DB_KB_RANG_PHARMA_1' then 'IUoj5RE30LA'
 when 'DB_KB_OG_PHARMA_1' then 'wQMUOn9W76B'
 when 'DB_KB_SH_QSPC_DM_1' then 'FBULuNMPIUu'
 when 'DB_KB_SH_QSPC_DM_2' then 'OXUkxfCdghH'
 when 'DB_KB_SH_QSPC_DM_3' then 'wdPAH8qR531'
 when 'DB_KB_SH_QSPC_DM_4' then 'jnqNSdkcHE0'
 when 'DB_KB_SH_QSPC_DM_5' then 'q1b8zzfTKrN'
 when 'DB_KB_SH_QSPC_DM_6' then 'E6ziu8pF6GE'
 when 'DB_KB_SH_QSPC_DM_7' then 'BTmRmXJ4Cp4'
 when 'DB_KB_SH_QSPC_DM_8' then 'QMB5tRpSwDP'
 when 'DB_KB_SH_QSPC_DM_9' then 'l4IM1CR2afH'
 END AS 'dataelement',
...
WHERE
    dbc.name IN  ('DB_KB_AG_PHARMA_1','DB_KB_STOCK_PHARMA_1','DB_KB_RANG_PHARMA_1','DB_KB_OG_PHARMA_1','DB_KB_SH_QSPC_DM_1','DB_KB_SH_QSPC_DM_2','DB_KB_SH_QSPC_DM_3','DB_KB_SH_QSPC_DM_4','DB_KB_SH_QSPC_DM_5','DB_KB_SH_QSPC_DM_6','DB_KB_SH_QSPC_DM_7','DB_KB_SH_QSPC_DM_8','DB_KB_SH_QSPC_DM_9')
