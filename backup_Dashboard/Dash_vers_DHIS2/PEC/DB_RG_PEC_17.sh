...
CSV_FILE="/home/herinomena/Documents/Export_dashbord_DHIS/Script_Migration_Dash_vers_DHIS2/PEC/DB_RG_PEC_17"

# Define SQL query
SQL_QUERY="SELECT 
    'M8F0v8SDAXn' AS 'dataelement',
    ...
    sum(datediff(rps.date,rpe.date)) AS 'value'
FROM
    register AS r
        LEFT JOIN
