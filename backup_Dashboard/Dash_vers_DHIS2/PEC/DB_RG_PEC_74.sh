...
CSV_FILE="/home/herinomena/Documents/Export_dashbord_DHIS/Script_Migration_Dash_vers_DHIS2/PEC/DB_RG_PEC_74"

# Define SQL query
SQL_QUERY="SELECT 
    'NcYH5jaJJKD' AS 'dataelement',
...
WHERE rpe.date IS NOT NULL
        AND rpe.is_refered=1
        and rpr.presence_fiche_reference=1
