...
CSV_FILE="/home/herinomena/Documents/Export_dashbord_DHIS/Script_Migration_Dash_vers_DHIS2/PEC/DB_RG_PEC_72"

# Define SQL query
SQL_QUERY="SELECT 
    'RbNWbdc8scv' AS 'dataelement',
...
WHERE
    pr.id IN (137 , 187)
        ...
        and rpts.id = 5
        and datediff(rps.date,rpe.date)<=1
