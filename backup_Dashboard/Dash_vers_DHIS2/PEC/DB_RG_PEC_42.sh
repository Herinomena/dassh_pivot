...
CSV_FILE="/home/herinomena/Documents/Export_dashbord_DHIS/Script_Migration_Dash_vers_DHIS2/PEC/DB_RG_PEC_42"

# Define SQL query
SQL_QUERY="SELECT 
    'JsPaIDEREJU' AS 'dataelement',
...
GROUP BY ccr.id , EXTRACT(YEAR_MONTH FROM DATE(rpe.date))
;"
