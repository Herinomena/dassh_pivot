...
CSV_FILE="/home/herinomena/Documents/Export_dashbord_DHIS/Script_Migration_Dash_vers_DHIS2/PEC/DB_RG_PEC_21"

# Define SQL query
SQL_QUERY="SELECT 
    'Ig76jrkQvJx' AS 'dataelement',
...
WHERE
    pr.id IN (137 , 187)
        ...
        and rps.cout_total is not null
