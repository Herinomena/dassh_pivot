...
CSV_FILE="/home/herinomena/Documents/Export_dashbord_DHIS/Script_Migration_Dash_vers_DHIS2/PEC/DB_RG_PEC_149"

# Define SQL query
SQL_QUERY="SELECT 
    'fHYqAkMFoOs' AS 'dataelement',
    EXTRACT(YEAR_MONTH FROM DATE(rps.date)) AS 'period',
    cc.orgunit AS 'orgunit',
     CASE rpts.id
		WHEN 19 THEN 'uAqkdEaLTYA'
        WHEN 17 THEN 'oUIBmHkRXHl'
        WHEN 15 THEN 'fZvbNvVuurS'
