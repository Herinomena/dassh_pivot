...
CSV_FILE="/home/herinomena/Documents/Export_dashbord_DHIS/Script_Migration_Dash_vers_DHIS2/MALNUT/Admission/AdmissionCrenasReferenceParAC"

# Define SQL query
SQL_QUERY="SELECT 
	'LeEDaWLtJE7' AS 'dataelement',
