...
CSV_FILE="/home/herinomena/Documents/Export_dashbord_DHIS/Script_Migration_Dash_vers_DHIS2/EXCEL/DB_KB_SOC_7_8"
...
SELECT 
    CASE dbc.name
        WHEN 'DB_KB_SOC_7' THEN 'Hag4EQPrpE4'
        WHEN 'DB_KB_SOC_8' THEN 'IBeLVXZSuQp'
    END AS 'dataelement',
...
WHERE
    dbc.name IN ('DB_KB_SOC_7' , 'DB_KB_SOC_8')
