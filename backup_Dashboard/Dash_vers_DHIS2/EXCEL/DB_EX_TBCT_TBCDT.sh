...
CSV_FILE="/home/herinomena/Documents/Export_dashbord_DHIS/Script_Migration_Dash_vers_DHIS2/EXCEL/DB_EX_TBCT_TBCDT"


# Define SQL query
SQL_QUERY="SET SESSION sql_mode=(SELECT REPLACE(@@sql_mode,'ONLY_FULL_GROUP_BY',''));
SELECT  
  CASE dbc.name                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    WHEN 5 THEN 'kXYZqOsQ29U' 
		WHEN 'DB_EX_TBCT_1' THEN 'tl3nBQcB6wf'
        WHEN 'DB_EX_TBCT_2' THEN 'GCpRSJeIiaN'
        WHEN 'DB_EX_TBCT_3' THEN 'vGtyYk2ZPF4'
        WHEN 'DB_EX_TBCT_4' THEN 'DfBQ8Hr2hNg'
        WHEN 'DB_EX_TBCT_5' THEN 'jQwbENVZ9jM'
        WHEN 'DB_EX_TBCT_6' THEN 'TPGzLem1qTJ'
		WHEN 'DB_EX_TBCDT_1' THEN 'JI5hQxDmUiz'
        WHEN 'DB_EX_TBCDT_2' THEN 'rdqi8mvPPWD'
        WHEN 'DB_EX_TBCDT_3' THEN 'lLMAHTnilRF'
        WHEN 'DB_EX_TBCDT_4' THEN 'tB5aJUysAVt'
        WHEN 'DB_EX_TBCDT_5' THEN 'czgPNrRXVMk'
        END AS 'dataelement',
...
WHERE
    dbc.name IN ('DB_EX_TBCT_6','DB_EX_TBCT_5','DB_EX_TBCT_4','DB_EX_TBCT_3','DB_EX_TBCT_2','DB_EX_TBCT_1','DB_EX_TBCDT_5','DB_EX_TBCDT_4','DB_EX_TBCDT_3','DB_EX_TBCDT_2','DB_EX_TBCDT_1') 
