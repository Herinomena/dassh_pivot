...
CSV_FILE="/home/herinomena/Documents/Export_dashbord_DHIS/Script_Migration_Dash_vers_DHIS2/EXCEL/DB_EX_SOC_47__50_62"
...
SELECT 
    CASE dbc.name
        WHEN 'DB_EX_SOC_47' THEN 'UuiimSbtt8j'
        WHEN 'DB_EX_SOC_48' THEN 'wIbJCam0VLz'
        WHEN 'DB_EX_SOC_49' THEN 'U0y6L5Lukd1'
        WHEN 'DB_EX_SOC_50' THEN 'smiXs2bhHYy'
        WHEN 'DB_EX_SOC_62' THEN 'kfHkGTNq4sl'
    END AS 'dataelement',
...
WHERE
    dbc.name IN ('DB_EX_SOC_47' , 'DB_EX_SOC_48','DB_EX_SOC_49','DB_EX_SOC_50','DB_EX_SOC_62')
