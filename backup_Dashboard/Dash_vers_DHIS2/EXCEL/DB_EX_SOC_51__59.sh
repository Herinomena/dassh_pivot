...
CSV_FILE="/home/herinomena/Documents/Export_dashbord_DHIS/Script_Migration_Dash_vers_DHIS2/EXCEL/DB_EX_SOC_51__59"
...
SELECT 
    CASE dbc.name
       WHEN 'DB_EX_SOC_51' THEN 'uaFSYJHhj2Y'
        WHEN 'DB_EX_SOC_52' THEN 'TcWNtKaAOaw'
        WHEN 'DB_EX_SOC_53' THEN 'gL9krACXGeR'
        WHEN 'DB_EX_SOC_54' THEN 'GzvH0wCjXBy'
        WHEN 'DB_EX_SOC_55' THEN 'S5kT80eVXM4'
        WHEN 'DB_EX_SOC_56' THEN 'j9r7UN9THb4'
        WHEN 'DB_EX_SOC_57' THEN 'cYPlhLWLwS3'
        WHEN 'DB_EX_SOC_58' THEN 'sdG0aqCGwzL'
        WHEN 'DB_EX_SOC_59' THEN 'sdG0aqCGwzL'
    END AS 'dataelement',
...
WHERE
    dbc.name IN ('DB_EX_SOC_51' , 'DB_EX_SOC_52','DB_EX_SOC_53','DB_EX_SOC_54','DB_EX_SOC_55','DB_EX_SOC_56','DB_EX_SOC_57','DB_EX_SOC_58','DB_EX_SOC_59')
