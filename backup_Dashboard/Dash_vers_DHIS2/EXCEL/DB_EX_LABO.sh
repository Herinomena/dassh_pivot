...
CSV_FILE="/home/herinomena/Documents/Export_dashbord_DHIS/Script_Migration_Dash_vers_DHIS2/EXCEL/DB_EX_LABO"
...
SELECT
	...
	CASE dbc.name
		WHEN 'DB_EX_LABO_9' THEN 'qsnOrt5TwcF'
		WHEN 'DB_EX_LABO_8' THEN 'zJf5doRTu0m'
		WHEN 'DB_EX_LABO_7' THEN 'PvGo3AgU6Sw'
		WHEN 'DB_EX_LABO_6' THEN 'tnpLfKRlK8W'
		WHEN 'DB_EX_LABO_5' THEN 'ndyjfTxagRD'
		WHEN 'DB_EX_LABO_4' THEN 'JhzaSptd9XQ'
		WHEN 'DB_EX_LABO_3' THEN 'LWoFJlHN6je'
		WHEN 'DB_EX_LABO_21' THEN 'iRwYAm29An2'
		WHEN 'DB_EX_LABO_20' THEN 'Mm7aoLDl6Vg'
		WHEN 'DB_EX_LABO_2' THEN 'hiTHlnluv6y'
		WHEN 'DB_EX_LABO_19' THEN 'cn15mlLpBtj'
		WHEN 'DB_EX_LABO_18' THEN 'kDLID9hzAts'
		WHEN 'DB_EX_LABO_17' THEN 'EFHv7H5boK5'
		WHEN 'DB_EX_LABO_16' THEN 'P572XVQ9A35'
		WHEN 'DB_EX_LABO_15' THEN 'L1xle446iqr'
		WHEN 'DB_EX_LABO_14' THEN 'qCZb86kVLJO'
		WHEN 'DB_EX_LABO_13' THEN 'BphwwTblII5'
		WHEN 'DB_EX_LABO_12' THEN 'h6k3qVtrxJL'
		WHEN 'DB_EX_LABO_11' THEN 'w2yILjKjYNu'
		WHEN 'DB_EX_LABO_10' THEN 'zFyCqbNDqIA'
		WHEN 'DB_EX_LABO_1' THEN 'gOjmakVpfJg'
	 END AS 'dataelement',
...
WHERE
    dbc.name IN ('DB_EX_LABO_9','DB_EX_LABO_8','DB_EX_LABO_7','DB_EX_LABO_6','DB_EX_LABO_5','DB_EX_LABO_4','DB_EX_LABO_3','DB_EX_LABO_21','DB_EX_LABO_20','DB_EX_LABO_2','DB_EX_LABO_19','DB_EX_LABO_18','DB_EX_LABO_17','DB_EX_LABO_16','DB_EX_LABO_15','DB_EX_LABO_14','DB_EX_LABO_13','DB_EX_LABO_12','DB_EX_LABO_11','DB_EX_LABO_10','DB_EX_LABO_1')
