...
CSV_FILE="/home/herinomena/Documents/Export_dashbord_DHIS/Script_Migration_Dash_vers_DHIS2/EXCEL/DB_EX_MI"
...
SELECT
	...
	CASE dbc.name
		WHEN 'EX_MI_VIH_VIVRE_2' THEN 'dmfAaR9rfYM'
		WHEN 'EX_MI_VIH_VIVRE_1' THEN 'WJjhOHAYJYP'
		WHEN 'EX_MI_VIH_RTB_4' THEN 'ryHJEVKA8jW'
		WHEN 'EX_MI_VIH_RTB_3' THEN 'u3UI4CkbWl4'
		WHEN 'EX_MI_VIH_RTB_2' THEN 'jYph2uArhw2'
		WHEN 'EX_MI_VIH_RTB_1' THEN 'VCMGJdV4PvB'
	 END AS 'dataelement',
...
WHERE
    dbc.name IN ('EX_MI_VIH_VIVRE_2','EX_MI_VIH_VIVRE_1','EX_MI_VIH_RTB_4','EX_MI_VIH_RTB_3','EX_MI_VIH_RTB_2','EX_MI_VIH_RTB_1')
