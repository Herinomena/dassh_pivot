...
CSV_FILE="/home/herinomena/Documents/Export_dashbord_DHIS/Script_Migration_Dash_vers_DHIS2/EXCEL/DB_EX_SOC_45_46_60"
...
SELECT 
    CASE dbc.name
        WHEN 'DB_EX_SOC_46' THEN 'DwU6eoAbjj1'
        WHEN 'DB_EX_SOC_45' THEN 'yPgrl57h5Qu'
        WHEN 'DB_EX_SOC_60' THEN 'IoYWCmf0Wm6'
    END AS 'dataelement',
...
WHERE
    dbc.name IN ('DB_EX_SOC_46' , 'DB_EX_SOC_45', 'DB_EX_SOC_60')
